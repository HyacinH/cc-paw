...
export function SnapshotDropdown({ snapshots, currentSessionId, onRestore, onDelete, onClose }: SnapshotDropdownProps) {
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    {isCurrent && (
                      <span className="shrink-0 text-[10px] px-1.5 py-0.5 bg-orange-400/15 text-orange-400 rounded font-medium">
                        当前
                      </span>
                    )}
                  </div>
